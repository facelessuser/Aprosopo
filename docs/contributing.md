...
|------------------|-------------|
| ST2&nbsp;<=&nbsp;version&nbsp;<&nbsp;ST3 | Currently supported and actively maintained as it requires little extra work, but on the official release of ST3, support will probably be discontinued. |
